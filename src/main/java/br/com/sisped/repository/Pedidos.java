...
import br.com.sisped.model.vo.DataValor;
import br.com.sisped.repository.filter.PedidoFilter;
...
public class Pedidos implements Serializable {
	...
	public Pedido guardar(Pedido pedido) {
		return this.entity.merge(pedido);
	}

	public Pedido porId(Long id) {
		return this.entity.find(Pedido.class, id);
	}
}